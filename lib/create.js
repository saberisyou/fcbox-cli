  ...
  const promptList = [
    {
      ...
      name: "system",
      choices: [
        { name: `Vue-prev - ${chalk.grey("Create project with a layout-only ant-design-pro boilerplate, use together with umi block.")}`, short: "✔️  Vue-prev", value: "vue-prev" },
        { name: `Vue-next - ${chalk.grey("Create project with a layout-only ant-design-pro boilerplate, use together with umi block.")}`, short: "✔️  Vue-next", value: "vue-next" },
        { name: `React    - ${chalk.grey("Create project with a layout-only ant-design-pro boilerplate, use together with umi block.")}`, short: "✔️  React", value: "react" },
      ],
      default: "vue-perv",
    },
    // {
