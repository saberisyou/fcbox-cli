 ...
 * @LastEditors: 乐祥孚
 * @LastEditTime: 2021-06-17 14:15:08
...
const welcome = async () => {
  ...
  titLog(data);
  console.log(bgGreyLog("INIT") + greyLog(`welcome to fcbox-cli . The current scaffold version is ${whiteLog("v" + require("../package.json").version)} `));
  console.log(greyLog(`please check whether the previous version is the latest.`));
  console.log("");
};
